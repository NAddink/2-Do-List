...
MC $$$ I always thought the cubicle walls were 'Sad Sand,' but according to Chapter 4, they're actually 'Despairful cream'.
...
MC $$$ Apparently, if I whisper a haiku to the paper tray, it might stop double-printing the invoices? Honestly, at this point, I'm willing to try the blood sacrifice suggested on page 42.
~ book_2 = true
-> main_menu

=== book3 ===
Book $$$ The Collected Poetry of a Sentient Excel Spreadsheet.
MC $$$ The line 'My cells are full, but my heart is '\#REF!' really hits different on a Monday. I'm actually starting to feel bad about that 'Clear All' I did earlier.
~ book_3 = true
-> main_menu

=== book4 ===
Book $$$ Aggressive Stapling: A Manifestation Guide.
MC $$$ The author insists that the thunk-clack sound is actually the universe saying 'Yes.'
~ book_4 = true
-> main_menu
...
=== book7 ===
Book $$$ Beyond the Cubicle: Is There Life After Fluorescent Lighting?
MC $$$ The author describes a phenomenon called 'The Sun,' which supposedly provides a 'full-spectrum' light that doesn't hum at a constant 60Hz. It sounds like a myth. I've spent so long under these flickering tubes that I'm starting to think my skin has developed its own pale, greenish bioluminescence.
~ book_7 = true
-> main_menu
